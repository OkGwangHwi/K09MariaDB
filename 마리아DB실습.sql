...
/*
	...
	속성을 사용하지만 MairaDB는 limit를 사용한다.
...
기존의 게시판을 멀티게시판으로 변경
	...
	질문과답변 : qna
	FAQ : faq
하나의 테이블로 여러개의 게시판을 제작하는경우 게시판의 구분을 위해
flag(플레그)가 필요하다.
*/
-- 공지사항 게시판에 글쓰기
INSERT INTO board (titme,content,id,bname)
